      ...
      body: Center(
        child: Column(
          ...
          children: const <Widget>[
            ...
            FlutterMarquee(children: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ', style: TextStyle(fontSize: 20), marqueeOn: 'render', marqueeSpeed:200),
            FlutterMarquee(children: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ', style: TextStyle(fontSize: 20), marqueeOn: 'hover', marqueeSpeed:200),
            FlutterMarquee(children: 'Lorem ipsum dolor sit amet', style: TextStyle(fontSize: 20)),
